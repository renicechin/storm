...
from STORM.sub_models.functions_losses import SymLogTwoHotLoss
from STORM.sub_models.attention_blocks import get_subsequent_mask_with_batch_length, get_subsequent_mask
from STORM.sub_models.transformer_model import StochasticTransformerKVCache
...
class EncoderBN(nn.Module):
    def __init__(self, in_channels, stem_channels, final_feature_width) -> None:
        ...
        while True:
            ...
            if feature_width == final_feature_width-1:
                break
...
class DecoderBN(nn.Module):
    def __init__(self, stoch_dim, last_channels, original_in_channels, stem_channels, final_feature_width) -> None:
        ...
        backbone = []
        # stem
        backbone.append(nn.Linear(stoch_dim, last_channels*final_feature_width*10, bias=False))
        ...
        backbone.append(nn.Upsample(size=(84, 168), mode='bilinear', align_corners=False))
        self.backbone = nn.Sequential(*backbone)
...
class WorldModel(nn.Module):
    def __init__(self, in_channels, action_dim,
        ...
        self.dist_head = DistHead(
            image_feat_dim=self.encoder.last_channels*self.final_feature_width*10,
